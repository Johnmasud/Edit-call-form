<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CFProductCallFormReport.aspx.cs" EnableViewStateMac="false" Inherits="CFProductCallFormReport" Title="SPAR - Internet Call Form Input" %>
...
%>  
 ...
 <asp:Button  OnClientClick="return Done()" ID="Button5"  runat="server" Text="Next >>" CssClass="Button"></asp:Button>
        <br />
        <br />
		       <asp:Label ID="Label1" runat="server" Text="If you are done with a Call Form then please click NEXT" CssClass="reportCriteriaHeader"></asp:Label>  
        <br />
        <br />
<%
}
...
{   
%>  
   <asp:Button  OnClientClick="return Back_Button()" ID="Button1"  runat="server" Text="<< Back" CssClass="Button"></asp:Button>             
<%
}  
%> 
</asp:Content>
