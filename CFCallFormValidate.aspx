<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" EnableViewStateMac="false" AutoEventWireup="true" CodeFile="CFCallFormValidate.aspx.cs" Inherits="CFCallFormValidate" Title="SPAR - Internet Call Form Input" %>
...
<input name="HiddenInsertQuestion" type="hidden" value="<%=HiddenInsertQuestion%>" />
